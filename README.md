...
| Current v0.15.0 queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP`；current issue `#1070`；`GH-1070-VERIFY-V0150-REAL-SPOT-TESTNET-CANCEL-REPLACE-RUNTIME`；`#1072..#1076` remain backlog / non-executable until dependencies are done |
