...
| Current v0.15.1 queue | `MTPRO Release v0.15.1 Real Testnet Execution Hardening Patch`；#1094 closed / done；#1095 closed / done；#1096 closed / done；#1097 closed / done；#1098 runtime internal gate closed / done；current issue `#1099`；`GH-1099-VERIFY-V0151-CLIENT-ORDER-IDENTITY-CHAIN`；`#1100` remains backlog / non-executable until dependencies are done |
