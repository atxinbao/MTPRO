...
| Current v0.15.1 queue | `MTPRO Release v0.15.1 Real Testnet Execution Hardening Patch`；#1094 closed / done；#1095 closed / done；#1096 closed / done；#1097 closed / done；current issue `#1098`；`GH-1098-VERIFY-V0151-RUNTIME-INTERNAL-GATES`；`#1099..#1100` remain backlog / non-executable until dependencies are done |
