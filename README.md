...
| Current v0.15.0 queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP`；current issue `#1069`；`GH-1069-VERIFY-V0150-REAL-SPOT-TESTNET-CANCEL-RUNTIME`；`#1070`、`#1072..#1076` remain backlog / non-executable until dependencies are done |
