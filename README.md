...
| Current v0.15.1 queue | `MTPRO Release v0.15.1 Real Testnet Execution Hardening Patch`；#1094 closed / done；#1095 closed / done；current issue `#1096`；`GH-1096-VERIFY-V0151-URLSESSION-SPOT-TESTNET-TRANSPORT`；`#1097..#1100` remain backlog / non-executable until dependencies are done |
