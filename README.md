...
| Current v0.15.0 queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP`；current issue `#1072`；`GH-1072-VERIFY-V0150-OMS-STATE-SYNC-RECONCILIATION`；`#1073..#1076` remain backlog / non-executable until dependencies are done |
