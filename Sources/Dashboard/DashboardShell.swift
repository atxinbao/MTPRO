...
public struct DashboardShellSnapshot: Codable, Equatable, Sendable {
    ...
    public let releaseV090OperatorUXSurface:
        ReleaseV090DashboardOperatorUXSurfaceViewModel
    public let releaseV0100ProductionReadinessCenter:
        ReleaseV0100DashboardProductionReadinessCenterViewModel
    public let releaseV0120AssessmentHistorySurface:
        ReleaseV0120DashboardAssessmentHistorySurfaceViewModel
    public let releaseV0140ReadOnlyExecutionDashboardSurface:
        ReleaseV0140ReadOnlyExecutionDashboardSurfaceViewModel
    public let releaseV0150DashboardTestnetExecutionStatusSurface:
        ReleaseV0150DashboardTestnetExecutionStatusSurfaceViewModel
    public let releaseV0160DashboardArtifactBackedExecutionView:
        ReleaseV0160DashboardArtifactBackedExecutionViewModel
    // GH-1144 Dashboard 只读 artifact validation error surface anchors:
    ...
    public let releaseV0170DashboardArtifactValidationErrorSurface:
        ReleaseV0170DashboardArtifactValidationErrorSurfaceViewModel
    // GH-1182 Dashboard 只读 artifact recovery drilldown anchors:
    ...
    public let releaseV0180DashboardArtifactRecoveryDrilldownSurface:
        ReleaseV0180DashboardArtifactRecoveryDrilldownSurfaceViewModel
    // GH-1213 Dashboard 只读 venue/product registry surface anchors:
    ...
    public let releaseV0190DashboardVenueProductRegistrySurface:
        ReleaseV0190DashboardVenueProductRegistrySurfaceViewModel
    // GH-1248 Dashboard / CLI read-only live readiness surface anchors:
    ...
    // GH-1318 Dashboard / CLI live canary evidence surface anchors:
    ...
    public let releaseV0220DashboardCLILiveCanaryEvidenceSurface:
    ...
    public init(
        ...
        releaseV0150DashboardTestnetExecutionStatusSurface:
            ReleaseV0150DashboardTestnetExecutionStatusSurfaceViewModel = .deterministicFixture,
        releaseV0160DashboardArtifactBackedExecutionView:
            ReleaseV0160DashboardArtifactBackedExecutionViewModel = .deterministicFixture,
        releaseV0170DashboardArtifactValidationErrorSurface:
            ReleaseV0170DashboardArtifactValidationErrorSurfaceViewModel = .deterministicFixture,
        releaseV0180DashboardArtifactRecoveryDrilldownSurface:
            ReleaseV0180DashboardArtifactRecoveryDrilldownSurfaceViewModel = .deterministicFixture,
        ...
        releaseV0220DashboardCLILiveCanaryEvidenceSurface:
            ReleaseV0220DashboardCLILiveCanaryEvidenceSurfaceViewModel = .deterministicFixture
    ) {
        self.title = title
        self.subtitle = subtitle
        ...
        self.releaseV0150DashboardTestnetExecutionStatusSurface =
            releaseV0150DashboardTestnetExecutionStatusSurface
        self.releaseV0160DashboardArtifactBackedExecutionView =
            releaseV0160DashboardArtifactBackedExecutionView
        self.releaseV0170DashboardArtifactValidationErrorSurface =
            releaseV0170DashboardArtifactValidationErrorSurface
        self.releaseV0180DashboardArtifactRecoveryDrilldownSurface =
            releaseV0180DashboardArtifactRecoveryDrilldownSurface
        self.releaseV0190DashboardVenueProductRegistrySurface =
            releaseV0190DashboardVenueProductRegistrySurface
        self.releaseV0200DashboardCLIReadOnlyLiveReadinessSurface =
            releaseV0200DashboardCLIReadOnlyLiveReadinessSurface
        self.releaseV0210DashboardCLICanaryStatusSurface =
            releaseV0210DashboardCLICanaryStatusSurface
        self.releaseV0220DashboardCLILiveCanaryEvidenceSurface =
            releaseV0220DashboardCLILiveCanaryEvidenceSurface
    ...
    public static func releaseV0150DashboardTestnetExecutionStatusSurface(fromLocalReadModelJSON data: Data
    ) throws -> ReleaseV0150DashboardTestnetExecutionStatusSurfaceViewModel {
        try ReleaseV0150DashboardTestnetExecutionStatusSurfaceViewModel.localReadModelArtifact(fromJSON: data)
    }

    public static func releaseV0160DashboardArtifactBackedExecutionView(fromLocalReadModelJSON data: Data
    ) throws -> ReleaseV0160DashboardArtifactBackedExecutionViewModel {
        try ReleaseV0160DashboardArtifactBackedExecutionViewModel.localReadModelArtifact(fromJSON: data)
    }

    public static func releaseV0170DashboardArtifactValidationErrorSurface(fromLocalReadModelJSON data: Data
    ) throws -> ReleaseV0170DashboardArtifactValidationErrorSurfaceViewModel {
        try ReleaseV0170DashboardArtifactValidationErrorSurfaceViewModel.localReadModelArtifact(fromJSON: data)
    }

    public static func releaseV0180DashboardArtifactRecoveryDrilldownSurface(fromLocalReadModelJSON data: Data
    ) throws -> ReleaseV0180DashboardArtifactRecoveryDrilldownSurfaceViewModel {
        try ReleaseV0180DashboardArtifactRecoveryDrilldownSurfaceViewModel.localReadModelArtifact(fromJSON: data)
    }
    ...
    public var viewModelSources: [ViewModelSourceContract] {
        sections.map(\.source)
            ...
            + [
                ...
                releaseV090OperatorUXSurface.source,
                releaseV0100ProductionReadinessCenter.source,
                releaseV0120AssessmentHistorySurface.source,
                releaseV0140ReadOnlyExecutionDashboardSurface.source,
                releaseV0150DashboardTestnetExecutionStatusSurface.source,
                releaseV0160DashboardArtifactBackedExecutionView.source,
                releaseV0170DashboardArtifactValidationErrorSurface.source,
                ...
                releaseV0220DashboardCLILiveCanaryEvidenceSurface.source,
    ...
    public var isReadModelOnly: Bool {
        viewModelSources.allSatisfy(\.isReadModelOnly)
            ...
            && releaseV090OperatorUXSurface.boundaryHeld
            && releaseV0100ProductionReadinessCenter.boundaryHeld
            && releaseV0120AssessmentHistorySurface.boundaryHeld
            && releaseV0140ReadOnlyExecutionDashboardSurface.boundaryHeld
            && releaseV0150DashboardTestnetExecutionStatusSurface.boundaryHeld
            && releaseV0160DashboardArtifactBackedExecutionView.boundaryHeld
            && releaseV0170DashboardArtifactValidationErrorSurface.boundaryHeld
            ...
            && releaseV0220DashboardCLILiveCanaryEvidenceSurface.boundaryHeld
    ...
    public var smokeSummary: String {
        ...
        let releaseV090OperatorUXControls = Self.metricValue(
            "v0.9 monitor UX controls",
            in: releaseV090OperatorUXSurface.metrics
        )
        let releaseV090OperatorUXCommands = Self.metricValue(
            "CLI monitor commands",
            in: releaseV090OperatorUXSurface.metrics
        )
        let releaseV090OperatorUXDashboardSurfaces = Self.metricValue(
            "Dashboard monitor surfaces",
            in: releaseV090OperatorUXSurface.metrics
        )
        let releaseV090OperatorUXExportStatus = Self.metricValue(
            "Export status",
            in: releaseV090OperatorUXSurface.metrics
        )
        let releaseV090OperatorUXBoundary = Self.metricValue(
            "Boundary",
            in: releaseV090OperatorUXSurface.metrics
        )
        let releaseV0100ReadinessCenterCards = Self.metricValue(
            "v0.10 readiness center cards",
            in: releaseV0100ProductionReadinessCenter.metrics
        )
        let releaseV0100ReadinessCenterPanels = Self.metricValue(
            "Readiness center panels",
            in: releaseV0100ProductionReadinessCenter.metrics
        )
        let releaseV0100ReadinessCenterEvidence = Self.metricValue(
            "Readiness evidence",
            in: releaseV0100ProductionReadinessCenter.metrics
        )
        let releaseV0100ReadinessCenterBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0100ProductionReadinessCenter.metrics
        )
        let releaseV0120AssessmentHistoryRows = Self.metricValue(
            "v0.12 assessment history rows",
            in: releaseV0120AssessmentHistorySurface.metrics
        )
        let releaseV0120AssessmentHistoryGenerations = Self.metricValue(
            "Generation history",
            in: releaseV0120AssessmentHistorySurface.metrics
        )
        let releaseV0120AssessmentHistoryAdversarialCases = Self.metricValue(
            "Adversarial guard cases",
            in: releaseV0120AssessmentHistorySurface.metrics
        )
        let releaseV0120AssessmentHistoryBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0120AssessmentHistorySurface.metrics
        )
        ...
        let releaseV0140ExecutionDashboardRows = Self.metricValue(
            "v0.14 execution dashboard rows",
            in: releaseV0140ReadOnlyExecutionDashboardSurface.metrics
        )
        let releaseV0140ExecutionLogEntries = Self.metricValue(
            "v0.14 execution log entries",
            in: releaseV0140ReadOnlyExecutionDashboardSurface.metrics
        )
        let releaseV0140ExecutionDashboardReconciliation = Self.metricValue(
            "v0.14 reconciliation",
            in: releaseV0140ReadOnlyExecutionDashboardSurface.metrics
        )
        let releaseV0140ExecutionDashboardBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0140ReadOnlyExecutionDashboardSurface.metrics
        )
        let releaseV0150ExecutionStatusRows = Self.metricValue(
            "v0.15 execution status rows",
            in: releaseV0150DashboardTestnetExecutionStatusSurface.metrics
        )
        let releaseV0150ExecutionActions = Self.metricValue(
            "v0.15 execution actions",
            in: releaseV0150DashboardTestnetExecutionStatusSurface.metrics
        )
        let releaseV0150ExecutionOMSState = Self.metricValue(
            "v0.15 OMS state",
            in: releaseV0150DashboardTestnetExecutionStatusSurface.metrics
        )
        let releaseV0150ExecutionReconciliation = Self.metricValue(
            "v0.15 reconciliation",
            in: releaseV0150DashboardTestnetExecutionStatusSurface.metrics
        )
        let releaseV0150ExecutionBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0150DashboardTestnetExecutionStatusSurface.metrics
        )
        let releaseV0160ArtifactRows = Self.metricValue(
            "v0.16 artifact rows",
            in: releaseV0160DashboardArtifactBackedExecutionView.metrics
        )
        let releaseV0160ActionSequence = Self.metricValue(
            "v0.16 action sequence",
            in: releaseV0160DashboardArtifactBackedExecutionView.metrics
        )
        let releaseV0160Reconciliation = Self.metricValue(
            "v0.16 reconciliation",
            in: releaseV0160DashboardArtifactBackedExecutionView.metrics
        )
        let releaseV0160ChecksumCount = Self.metricValue(
            "v0.16 checksum count",
            in: releaseV0160DashboardArtifactBackedExecutionView.metrics
        )
        let releaseV0160ArtifactBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0160DashboardArtifactBackedExecutionView.metrics
        )
        let releaseV0170ArtifactValidationRows = Self.metricValue(
            "v0.17 artifact validation rows",
            in: releaseV0170DashboardArtifactValidationErrorSurface.metrics
        )
        let releaseV0170ArtifactValidationStatus = Self.metricValue(
            "v0.17 artifact validation",
            in: releaseV0170DashboardArtifactValidationErrorSurface.metrics
        )
        let releaseV0170ArtifactValidationRecovery = Self.metricValue(
            "v0.17 recovery",
            in: releaseV0170DashboardArtifactValidationErrorSurface.metrics
        )
        let releaseV0170ArtifactValidationReasons = Self.metricValue(
            "v0.17 failure reasons",
            in: releaseV0170DashboardArtifactValidationErrorSurface.metrics
        )
        let releaseV0170ArtifactValidationBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0170DashboardArtifactValidationErrorSurface.metrics
        )
        let releaseV0180DrilldownRows = Self.metricValue(
            "v0.18 drilldown rows",
            in: releaseV0180DashboardArtifactRecoveryDrilldownSurface.metrics
        )
        let releaseV0180DrilldownNamespace = Self.metricValue(
            "v0.18 namespace",
            in: releaseV0180DashboardArtifactRecoveryDrilldownSurface.metrics
        )
        let releaseV0180DrilldownFailureClasses = Self.metricValue(
            "v0.18 failure classes",
            in: releaseV0180DashboardArtifactRecoveryDrilldownSurface.metrics
        )
        let releaseV0180DrilldownNextActions = Self.metricValue(
            "v0.18 next actions",
            in: releaseV0180DashboardArtifactRecoveryDrilldownSurface.metrics
        )
        let releaseV0180DrilldownBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0180DashboardArtifactRecoveryDrilldownSurface.metrics
        )
        let releaseV0190RegistryRows = Self.metricValue(
            "v0.19 registry rows",
            in: releaseV0190DashboardVenueProductRegistrySurface.metrics
        )
        let releaseV0190RegistryStates = Self.metricValue(
            "v0.19 registry states",
            in: releaseV0190DashboardVenueProductRegistrySurface.metrics
        )
        let releaseV0190RegistryForbidden = Self.metricValue(
            "v0.19 forbidden capabilities",
            in: releaseV0190DashboardVenueProductRegistrySurface.metrics
        )
        let releaseV0190RegistryBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0190DashboardVenueProductRegistrySurface.metrics
        )
        let releaseV0200ReadinessRows = Self.metricValue(
            "v0.20 readiness rows",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        let releaseV0200ReadinessStates = Self.metricValue(
            "v0.20 readiness states",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        let releaseV0200EndpointClasses = Self.metricValue(
            "Endpoint classes",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        let releaseV0200CredentialStates = Self.metricValue(
            "Credential states",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        let releaseV0200NoOrderStatuses = Self.metricValue(
            "No-order statuses",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        let releaseV0200ReadinessBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0200DashboardCLIReadOnlyLiveReadinessSurface.metrics
        )
        ...
        let releaseV0220CanaryEvidenceRows = Self.metricValue(
            "v0.22 canary evidence rows",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
        let releaseV0220CanaryEvidenceStates = Self.metricValue(
            "v0.22 states",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
        let releaseV0220CanaryEvidenceFailures = Self.metricValue(
            "Failure classes",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
        let releaseV0220CanaryEvidenceNextActions = Self.metricValue(
            "Next actions",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
        let releaseV0220CanaryEvidenceRollback = Self.metricValue(
            "Rollback commands",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
        let releaseV0220CanaryEvidenceBoundary = Self.metricValue(
            "Boundary",
            in: releaseV0220DashboardCLILiveCanaryEvidenceSurface.metrics
        )
    ...
    public var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                DashboardReleaseV090OperatorUXPanel(surface: snapshot.releaseV090OperatorUXSurface)
                DashboardReleaseV0100ProductionReadinessCenterPanel(
                    surface: snapshot.releaseV0100ProductionReadinessCenter
                )
                DashboardReleaseV0120AssessmentHistoryPanel(
                    surface: snapshot.releaseV0120AssessmentHistorySurface
                )
                DashboardReleaseV0140ReadOnlyExecutionPanel(
                    surface: snapshot.releaseV0140ReadOnlyExecutionDashboardSurface
                )
                DashboardReleaseV0150TestnetExecutionStatusPanel(
                    surface: snapshot.releaseV0150DashboardTestnetExecutionStatusSurface
                )
                DashboardReleaseV0160ArtifactBackedExecutionPanel(
                    surface: snapshot.releaseV0160DashboardArtifactBackedExecutionView
                )
                DashboardReleaseV0170ArtifactValidationErrorPanel(
                    surface: snapshot.releaseV0170DashboardArtifactValidationErrorSurface
                )
                DashboardReleaseV0180ArtifactRecoveryDrilldownPanel(
                    surface: snapshot.releaseV0180DashboardArtifactRecoveryDrilldownSurface
                )
                DashboardReleaseV0190VenueProductRegistryPanel(
                    surface: snapshot.releaseV0190DashboardVenueProductRegistrySurface
                )
                ...
                DashboardReleaseV0220LiveCanaryEvidencePanel(
                    surface: snapshot.releaseV0220DashboardCLILiveCanaryEvidenceSurface
                )
...
private struct DashboardReleaseV090OperatorUXPanel: View {
    let surface: ReleaseV090DashboardOperatorUXSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.9 Operator UX",
            systemImage: "terminal",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Monitor start, status, stop, recover and export UX only; no order, broker, endpoint or production command")
    }
}

private struct DashboardReleaseV0100ProductionReadinessCenterPanel: View {
    let surface: ReleaseV0100DashboardProductionReadinessCenterViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.10 Production Readiness",
            systemImage: "checklist.checked",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only production readiness center; no trading button, order form, live command or cutover")
    }
}

private struct DashboardReleaseV0120AssessmentHistoryPanel: View {
    let surface: ReleaseV0120DashboardAssessmentHistorySurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.12 Assessment History",
            systemImage: "clock.arrow.circlepath",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only assessment history and adversarial validation evidence; no order, endpoint, broker, or cutover")
    }
}

private struct DashboardReleaseV0140ReadOnlyExecutionPanel: View {
    let surface: ReleaseV0140ReadOnlyExecutionDashboardSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.14 Execution Status",
            systemImage: "list.bullet.rectangle",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only execution closed-loop status; no trading button, order form, command or cutover")
    }
}

private struct DashboardReleaseV0150TestnetExecutionStatusPanel: View {
    let surface: ReleaseV0150DashboardTestnetExecutionStatusSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.15 Testnet Execution Status",
            systemImage: "checklist.unchecked",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only Spot Testnet submit/cancel/cancel-replace status; no trading button or command")
    }
}

private struct DashboardReleaseV0160ArtifactBackedExecutionPanel: View {
    let surface: ReleaseV0160DashboardArtifactBackedExecutionViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.16 Artifact-backed Execution",
            systemImage: "doc.text.magnifyingglass",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only local artifact and OMS reconciliation view; no trading button, order form, command or cutover")
    }
}

private struct DashboardReleaseV0170ArtifactValidationErrorPanel: View {
    let surface: ReleaseV0170DashboardArtifactValidationErrorSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.17 Artifact Validation Errors",
            systemImage: "exclamationmark.triangle",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only artifact validation and recovery errors; no trading button, order form, command or cutover")
    }
}

private struct DashboardReleaseV0180ArtifactRecoveryDrilldownPanel: View {
    let surface: ReleaseV0180DashboardArtifactRecoveryDrilldownSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.18 Artifact Recovery Drilldown",
            systemImage: "arrow.triangle.branch",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only local bundle recovery drilldown; no trading button, order form, command or cutover")
    }
}

private struct DashboardReleaseV0190VenueProductRegistryPanel: View {
    let surface: ReleaseV0190DashboardVenueProductRegistrySurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.19 Venue/Product Registry",
            systemImage: "tablecells",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only venue/product registry support status; no trading button, order form, command or cutover")
    }
}

private struct DashboardReleaseV0200ReadOnlyLiveReadinessPanel: View {
    let surface: ReleaseV0200DashboardCLIReadOnlyLiveReadinessSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.20 Production-shadow Readiness",
...
private struct DashboardReleaseV0220LiveCanaryEvidencePanel: View {
    let surface: ReleaseV0220DashboardCLILiveCanaryEvidenceSurfaceViewModel

    var body: some View {
        DashboardReadModelDetailGroup(
            title: "Release v0.22 Live Canary Evidence",
            systemImage: "eye.trianglebadge.exclamationmark",
            metrics: surface.metrics,
            details: surface.details
        )
        .help("Read-only Spot live canary evidence, failure class, next action and rollback view; no trading button, order form, command or cutover")
    }
}
