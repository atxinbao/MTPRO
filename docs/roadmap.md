...
Next recommended maturity slice：`release/v0.13.0` / #998 `V013-05 Upgrade validate to full evidence-chain consistency check` active evidence-chain validate gate。

Next maturity planning candidate：#999 至 #1005 仍 blocked by #998；real broker / production trading / next Project 仍必须经 Human + `@001 / PLN` 重新规划。
