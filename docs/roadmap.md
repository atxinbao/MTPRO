...
| Releases | Completed | v0.1.0 Binance + EMA、v0.2.0 Binance Spot + USDⓈ-M Perpetual + EMA/RSI、v0.3.0 rehearsal evidence、v0.4.0 unified runtime rehearsal、v0.5.0 guarded testnet runtime foundation 均 completed；production trading 默认保持关闭。 |
