...
当前 release construction scope 是 `MTPRO Release v0.2.0`。它使用 GitHub fallback issue queue GH-563 至 GH-596 作为唯一队列来源；Linear 不参与本阶段执行。该 scope 不改变已完成 Project Map，不授权创建下一 Project / Issue，不推进 release v0.2.0 之后的阶段。
...
Latest Completed Project：`MTPRO Release v0.1.0`
