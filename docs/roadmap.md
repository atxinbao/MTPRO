...
Next recommended maturity slice：`release/v0.13.0` / #1000 `V013-07 Upgrade comparison to evidence-level diff` active evidence-level diff / compare gate。

Next maturity planning candidate：#1001 至 #1005 仍 blocked by #1000；real broker / production trading / next Project 仍必须经 Human + `@001 / PLN` 重新规划。
