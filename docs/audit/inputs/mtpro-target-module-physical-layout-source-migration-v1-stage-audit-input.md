...
| `docs/architecture.md` | 当前 source tree 已从旧粗粒度目录迁往目标 module directories，但 SwiftPM target graph 仍保留 compatibility envelope；不得把目录迁移误写成 runtime implementation 完成。 |
