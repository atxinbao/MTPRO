...
| `docs/architecture.md` | 当前 source tree 已把 concrete strategy code 归入 Trader-owned strategy root，但 SwiftPM target graph 仍保留 compatibility envelope；不得把目录修正误写成 runtime implementation 完成。 |
