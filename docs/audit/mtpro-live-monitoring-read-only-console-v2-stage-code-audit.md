...
| `architecture.md` | 可标记 L3.3 evidence chain 已完成：deterministic Core contract -> App read model / ViewModel -> Dashboard / Report / Event Timeline；不得把 signed/account/broker/OMS/live command 模块写成当前 runtime。 |
