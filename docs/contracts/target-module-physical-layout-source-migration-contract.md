...
| `Sources/App/*` | `Sources/Workbench/ReadModels/`, `Sources/Workbench/Report/`, `Sources/Workbench/Dashboard/`, `Sources/Workbench/Events/` | Workbench consumes ReadModel / ViewModel only; no runtime object, adapter request or schema access. |
