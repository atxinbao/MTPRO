...
- Evidence files: `Sources/ExecutionClient/FutureGate/ReleaseV0160CLIOrderStatusQueryFlow.swift`、`docs/contracts/release-v0.16.0-binance-spot-testnet-order-status-query-contract.md`、`docs/validation/latest-verification-summary.md`、`docs/validation/validation-plan.md`、`docs/automation/automation-readiness.md`、`docs/release/release-publication-policy.md`、`docs/release/mtpro-release-v0.16.1-operator-beta-evidence-hardening-patch-notes.md`、`checks/verify-v0.16.1-status-query-transport-wording.sh`、`checks/run.sh` 和 `checks/automation-readiness.sh`。
- Boundary: GH-1137 clarifies that `networkStatusQueryPerformed=false` is a request-evidence flag, while guarded Testnet status transport result evidence remains represented by `ReleaseV0160BinanceSpotTestnetOrderStatusTransportResult`, redacted request / response evidence, artifact path and checksum. It does not describe the status query as fake / mock, does not overstate production readiness, does not read production secret, does not connect production endpoint / broker endpoint, does not send testnet or production order, and does not authorize production cutover.
...
The matrix validates Binance USD-M Futures testnet controlled execution foundation only. `productionFuturesOrderExecutionEnabled=false`; production cutover not authorized; Dashboard trading controls remain disabled.

## Release v0.26.1 Publication Fact Sync / Milestone Closure Patch

| Anchor | Evidence |
| --- | --- |
| v0.26.1 publication fact sync | `GH-1406-VERIFY-V0261-V0260-RELEASE-FACT-SYNC`, `TVM-RELEASE-V0261-V0260-RELEASE-FACT-SYNC`, `V0261-001-V0260-GITHUB-RELEASE-PUBLISHED`, `V0261-001-V0260-TAG-FIXED`, `V0261-001-V0260-PUBLISHED-AT-2026-07-08T13-00-01Z`; records https://github.com/atxinbao/MTPRO/releases/tag/v0.26.0, tag target `e3b65f2337c5275eaa7ce5c5f224b69475a7c9bb`, and published at `2026-07-08T13:00:01Z` |
| v0.26.1 milestone closure | `GH-1407-VERIFY-V0261-V0260-MILESTONE-COMPLETION`, `V0261-002-V0260-MILESTONE-CLOSED`, `V0261-002-V0260-ISSUES-1394-1403-DONE`; v0.26.0 milestone #43 is closed with 0 open / 10 closed issues and #1394 through #1403 closed / done |
| v0.26.1 stale wording and baseline guard | `GH-1408-VERIFY-V0261-V0260-STALE-WORDING-GUARD`, `V0261-003-PUBLISHED-V0260-STALE-WORDING-GUARD`, `GH-1409-VERIFY-V0261-V0260-BASELINE-WORDING`, `V0261-004-V0260-CURRENT-PUBLISHED-BASELINE`, `V0261-004-FUTURES-TESTNET-CONTROLLED-EXECUTION-FOUNDATION`; current maturity is `Binance USD-M Futures testnet controlled execution foundation` |
| v0.26.1 patch closeout | `GH-1410-VERIFY-V0261-PATCH-AUDIT-RELEASE-NOTES`, `V0261-005-PATCH-AUDIT`, `V0261-005-V0270-BLOCKED-BY-V0261-COMPLETION`, `V0261-005-NO-CAPABILITY-CHANGE`; production cutover not authorized and v0.27.0 remains blocked until v0.26.1 completion |
...
| Surface | v0.29.0 validation | Required result |
| --- | --- | --- |
| Production dry-run / shadow acceptance | `ReleaseV0290ProductionDryRunShadowAcceptance` | `evidenceComplete=true`, `boundaryHeld=true` |
| Secret handling | Credential reference and approval evidence only | `productionSecretAutoReadEnabled=false` |
| Broker connectivity | Endpoint allowlist / no-submit preflight evidence only | `automaticBrokerConnectionEnabled=false`, `noSubmitTransportMode=true` |
| Orders | Shadow evidence only | `productionSubmitCancelReplaceEnabled=false` |
...
## Release v0.31.1 Controlled Enablement Integrity Repair / v0.32.0 Controlled Canary Operations Matrix

| Surface | Anchors | Required result |
| --- | --- | --- |
| v0.31.1 publication gate | `GH-1499-VERIFY-V0311-RELEASE-PUBLICATION-GATE`, `TVM-RELEASE-V0311-CONTROLLED-ENABLEMENT-INTEGRITY-REPAIR`, `V0311-001-RELEASE-PUBLICATION-AFTER-FULL-MATRIX` | release publication waits for PR fast, Linux, dashboard macOS and publication checks |
| v0.31.1 endpoint allowlist | `GH-1500-VERIFY-V0311-ENDPOINT-ALLOWLIST-METHOD-HOST-PATH`, `V0311-002-ENDPOINT-METHOD-HOST-PATH-PRODUCT-FAMILY` | endpoint method, host, path, product, family and query shape are constrained |
| v0.31.1 approval / lock / artifact / risk | `GH-1501-VERIFY-V0311-APPROVAL-SCOPE-EXPIRY-POLICY`, `GH-1502-VERIFY-V0311-PERSISTENT-RUN-LOCK-REPLAY`, `GH-1503-VERIFY-V0311-EVIDENCE-ROOT-ARTIFACT-VALIDATION`, `GH-1504-VERIFY-V0311-RISK-GATE-NEGATIVE-INPUTS`, `GH-1505-VERIFY-V0311-NEGATIVE-REGRESSION-MATRIX`, `GH-1506-VERIFY-V0311-V0310-PUBLICATION-FACTS`, `GH-1507-VERIFY-V0311-STAGE-AUDIT-RELEASE-NOTES`, `V0311-003-APPROVAL-SCOPE-EXPIRY-SOURCE-POLICY`, `V0311-004-PERSISTENT-RUN-LOCK-REPLAY-PROTECTION`, `V0311-005-EVIDENCE-ROOT-ARTIFACT-VALIDATION`, `V0311-006-RISK-GATE-NEGATIVE-INPUTS`, `V0311-007-NEGATIVE-REGRESSION-MATRIX`, `V0311-008-V0310-PUBLICATION-FACTS`, `V0311-009-STAGE-AUDIT-RELEASE-NOTES` | invalid approvals, replay locks, artifact roots and risk inputs fail closed |
| v0.32.0 contract / approval / size cap | `GH-1508-VERIFY-V0320-CANARY-OPERATIONS-CONTRACT`, `GH-1509-VERIFY-V0320-HUMAN-APPROVED-ENABLEMENT-BUNDLE`, `GH-1510-VERIFY-V0320-STRICT-SIZE-CAP-FINAL-GATE`, `TVM-RELEASE-V0320-BINANCE-CONTROLLED-PRODUCTION-CANARY-OPERATIONS`, `V0320-001-CANARY-OPERATIONS-CONTRACT`, `V0320-002-HUMAN-APPROVED-ENABLEMENT-BUNDLE`, `V0320-003-STRICT-SIZE-CAP-FINAL-GATE` | Binance Spot + USD-M Futures canary evidence requires human approval and strict size caps |
| v0.32.0 operations / OMS / incident / Dashboard | `GH-1511-VERIFY-V0320-SPOT-CANARY-SUBMIT-STATUS-CANCEL`, `GH-1512-VERIFY-V0320-FUTURES-CANARY-SUBMIT-STATUS-CANCEL`, `GH-1513-VERIFY-V0320-OMS-RECONCILIATION-ROLLBACK`, `GH-1514-VERIFY-V0320-KILL-NOTRADE-INCIDENT-STOP`, `GH-1515-VERIFY-V0320-DASHBOARD-CLI-CANARY-STATUS`, `GH-1516-VERIFY-V0320-AGGREGATE-VALIDATION-SUITE`, `GH-1517-VERIFY-V0320-STAGE-AUDIT-RELEASE-DOCS`, `V0320-004-SPOT-CANARY-SUBMIT-STATUS-CANCEL`, `V0320-005-FUTURES-CANARY-SUBMIT-STATUS-CANCEL`, `V0320-006-OMS-RECONCILIATION-ROLLBACK`, `V0320-007-KILL-NOTRADE-INCIDENT-STOP`, `V0320-008-DASHBOARD-CLI-CANARY-STATUS`, `V0320-009-AGGREGATE-VALIDATION-SUITE`, `V0320-010-STAGE-AUDIT-RELEASE-DOCS` | canary submit/status/cancel evidence is gated; OMS is append-only; Dashboard / CLI remains read-only |

## Release v0.32.1 Controlled Canary Integrity / Publication Gate Repair Matrix

| Surface | Anchors | Required result |
| --- | --- | --- |
| v0.32.1 acceptance and artifact integrity | `GH-1519-VERIFY-V0321-ACCEPTANCE-SEMANTICS-PUBLICATION-FACTS`, `GH-1520-VERIFY-V0321-EVIDENCE-ROOT-MANIFEST-SHA256`, `TVM-RELEASE-V0321-CONTROLLED-CANARY-INTEGRITY-PUBLICATION-GATE-REPAIR`, `V0321-001-ACCEPTANCE-SEMANTICS-PUBLICATION-FACTS`, `V0321-002-EVIDENCE-ROOT-MANIFEST-SHA256` | explicit evidence root required; artifacts must exist and match recomputed SHA-256; deterministic fixture remains `acceptanceDecision=blocked-observed-production-canary-missing` |
| v0.32.1 approval, run lock and caps | `GH-1521-VERIFY-V0321-APPROVAL-SCOPE-RUN-LOCK`, `GH-1522-VERIFY-V0321-CAP-VALIDATION-NEGATIVE-MATRIX`, `V0321-003-APPROVAL-SCOPE-RUN-LOCK`, `V0321-004-CAP-VALIDATION-NEGATIVE-MATRIX` | approval source commit / scope / expiry and persistent run lock must hold; negative, stale or over-cap inputs fail closed |
| v0.32.1 operation artifacts and OMS linkage | `GH-1523-VERIFY-V0321-UNIQUE-SPOT-FUTURES-ARTIFACT-SETS`, `GH-1524-VERIFY-V0321-OMS-RECONCILIATION-ROLLBACK-INCIDENT-LINKAGE`, `V0321-005-UNIQUE-SPOT-FUTURES-ARTIFACT-SETS`, `V0321-006-OMS-RECONCILIATION-ROLLBACK-INCIDENT-LINKAGE` | Spot and USD-M Futures each require unique submit / status / cancel artifacts; OMS reconciliation, rollback and incident artifacts must link to the same run |
| v0.32.1 publication gate and closeout | `GH-1525-VERIFY-V0321-FULL-MATRIX-BEFORE-RELEASE`, `GH-1526-VERIFY-V0321-AGGREGATE-STAGE-AUDIT-RELEASE-DOCS`, `V0321-007-FULL-MATRIX-BEFORE-RELEASE`, `V0321-008-AGGREGATE-STAGE-AUDIT-RELEASE-DOCS` | release publication requires PR fast checks, Linux checks, dashboard macOS and release publication checks before tag/release publication |

## Release v0.32.2 Controlled Canary Integrity Closure Patch Matrix

| Surface | Anchors | Required result |
| --- | --- | --- |
| v0.32.2 release publication gate | `GH-1528-VERIFY-V0322-RELEASE-CREATION-BEHIND-FULL-MATRIX`, `TVM-RELEASE-V0322-CONTROLLED-CANARY-INTEGRITY-CLOSURE-PATCH`, `V0322-001-RELEASE-CREATION-BEHIND-FULL-MATRIX` | GitHub Release creation is performed by the final release-publication job after PR fast checks, Linux checks, dashboard macOS checks, and release-publication checks complete |
| v0.32.2 trusted observed-canary provenance | `GH-1529-VERIFY-V0322-TRUSTED-PROVENANCE-DERIVED-OBSERVED-CANARY`, `V0322-002-TRUSTED-PROVENANCE-DERIVED-OBSERVED-CANARY` | observed canary acceptance is derived from trusted workflow and artifact provenance, not from manifest self-report; required result is `observedProductionCanary=false` and `acceptanceDecision=blocked-trusted-observed-canary-missing` |
| v0.32.2 approval freshness and commit binding | `GH-1530-VERIFY-V0322-COMMIT-CLOCK-APPROVAL-FRESHNESS`, `V0322-003-COMMIT-CLOCK-APPROVAL-FRESHNESS` | approval evidence must bind to the current source commit, use trusted-clock expiry, and remain fresh for the evaluated run |
