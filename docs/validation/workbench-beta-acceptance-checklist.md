...
- Dashboard smoke 失败：检查 `Sources/Dashboard/DashboardApplication.swift`、`Sources/Dashboard/DashboardShell.swift`、`Sources/Dashboard/WorkbenchBetaFirstRunState.swift` 和 `Sources/Dashboard/WorkbenchBetaAcceptancePath.swift` 的 read-model-only assembly。
