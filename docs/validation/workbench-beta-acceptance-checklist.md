...
- Dashboard smoke 失败：检查 `Sources/Dashboard/DashboardApplication.swift`、`Sources/Dashboard/DashboardShell.swift`、`Sources/Dashboard/DashboardBetaFirstRunState.swift` 和 `Sources/Dashboard/DashboardBetaAcceptancePath.swift` 的 read-model-only assembly。
