...
| Current queue | `MTPRO Release v0.15.1 Real Testnet Execution Hardening Patch` active as GitHub fallback queue；#1094 release fact sync guard closed / done；#1095 injected transport wording guard closed / done；#1096 concrete URLSession Spot Testnet transport closed / done；#1097 CLI guarded runtime wiring closed / done；#1098 runtime internal gate is current WIP=1；#1099..#1100 remain backlog / non-executable until dependencies are done |
