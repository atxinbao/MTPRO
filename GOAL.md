...
| Current queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP` active as GitHub fallback queue；#1066 contract / v0.14.1 preflight gate is closed / done；#1067 testnet credential / signed request builder gate is closed / done；#1068 is the current WIP=1 real Spot Testnet submit runtime gate；#1069..#1076 remain backlog / non-executable |
