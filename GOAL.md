...
| Current queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP` active as GitHub fallback queue；#1066 contract / v0.14.1 preflight gate is closed / done；#1067 testnet credential / signed request builder gate is closed / done；#1068 real Spot Testnet submit runtime gate is closed / done；#1071 network execution event log gate is closed / done；#1069 real Spot Testnet cancel runtime gate is closed / done；#1070 is the current WIP=1 real Spot Testnet cancel-replace runtime gate；#1072..#1076 remain backlog / non-executable |
