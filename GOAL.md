...
| Current queue | `MTPRO Release v0.15.0 Real Binance Testnet Execution MVP` active as GitHub fallback queue；#1066 contract / v0.14.1 preflight gate is closed / done；#1067 is the current WIP=1 testnet credential / signed request builder gate；#1068..#1076 remain backlog / non-executable |
