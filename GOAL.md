...
- 当前 live queue source 为 GitHub fallback `release/v0.13.0`，#994 contract gate、#995 local evidence intake model gate、#996 synthetic provenance rejection gate、#997 build pipeline gate、#998 evidence-chain validate gate、#999 redacted audit export package gate 和 #1000 evidence-level diff / compare gate 已完成；#1001 是唯一 active transaction recovery forensic snapshot gate；#1002..#1005 保持 blocked，直到 #1001 PR merged / required checks success / issue closed done / main fast-forward / fresh WIP=1 preflight。Release v0.12.0 completion、v0.12.1 patch closeout、v0.13.0 contract gate、#995 local evidence intake model、#996 synthetic provenance rejection、#997 build pipeline、#998 evidence-chain validate、#999 redacted audit export package、#1000 evidence-level diff / compare 和当前 #1001 transaction recovery forensic snapshot 不授权 strategy 直连 ExecutionClient、broker command、production OMS、trading button、Live PRO Console production command、live command、real broker、real order、testnet order routing、production cutover 或任何 production trading。
