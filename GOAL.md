...
- 当前 live queue source 为 GitHub fallback `release/v0.13.0`，#994 contract gate、#995 local evidence intake model gate、#996 synthetic provenance rejection gate、#997 build pipeline gate、#998 evidence-chain validate gate、#999 redacted audit export package gate、#1000 evidence-level diff / compare gate、#1001 transaction recovery forensic snapshot gate、#1002 generation ID collision-proofing gate 和 #1003 ordered CLI execution lifecycle gate 已完成；#1004 是唯一 active local evidence fixtures and regression suite gate；#1005 保持 blocked，直到 #1004 PR merged / required checks success / issue closed done / main fast-forward / fresh WIP=1 preflight。Release v0.12.0 completion、v0.12.1 patch closeout、v0.13.0 contract gate、#995 local evidence intake model、#996 synthetic provenance rejection、#997 build pipeline、#998 evidence-chain validate、#999 redacted audit export package、#1000 evidence-level diff / compare、#1001 transaction recovery forensic snapshot、#1002 generation ID collision-proofing、#1003 ordered CLI execution lifecycle 和当前 #1004 local evidence fixtures / regression suite 不授权 strategy 直连 ExecutionClient、broker command、production OMS、trading button、Live PRO Console production command、live command、real broker、real order、testnet order routing、production cutover 或任何 production trading。
