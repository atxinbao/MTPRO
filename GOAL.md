...
| Active v0.16.1 patch queue | `MTPRO Release v0.16.1 Operator Beta Evidence Hardening Patch` is a GitHub fallback patch queue after v0.16.0 publication；GH-1133 uses `GH-1133-VERIFY-V0161-V0160-RELEASE-FACT-SYNC`, `V0161-001-V0160-RELEASE-FACT-SYNC-GUARD`, `TVM-RELEASE-V0161-V0160-RELEASE-FACT-SYNC`, `V0161-001-V0160-TAG-FIXED`, `V0161-001-PATCH-QUEUE-NOT-PUBLICATION` and `V0161-001-NO-PRODUCTION-CUTOVER` to keep v0.16.0 Release URL `https://github.com/atxinbao/MTPRO/releases/tag/v0.16.0`, tag peeled commit `28779236262bd7ffaf71e286b27b95854c5cd3e1` and publication timestamp `2026-06-26T01:29:21Z` synchronized；v0.16.1 is patch evidence only, does not move v0.16.0 tag, does not overwrite release, and production cutover not authorized |
