...
- 保持 production trading disabled by default，不授权 production cutover，不创建 tag 或 GitHub Release。
...
| 命令 | 结果 | 说明 |
| --- | --- | --- |
| `bash checks/verify-v0.10.0.sh` | 待执行 | 聚合 v0.10.0 focused verifiers 和 root docs guards |
