...
require_file_contains "README.md" "MTPRO Release v0.6.0 Local Operational Runtime + Testnet Read-only Probe Hardening"
require_file_contains "GOAL.md" "MTPRO Release v0.6.0 Local Operational Runtime + Testnet Read-only Probe Hardening"
require_file_contains "BLUEPRINT.md" "MTPRO Release v0.6.0 Local Operational Runtime + Testnet Read-only Probe Hardening"
require_file_contains "docs/roadmap.md" "GH-766-RELEASE-V060-FINAL-AUDIT-ROOT-DOCS"
