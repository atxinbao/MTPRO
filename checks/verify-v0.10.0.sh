...
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "MTPRO Release v0.10.0 Production Cutover Readiness Gate"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "bash checks/verify-v0.10.0.sh"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "MTPRO Release v0.10.0 Production Cutover Readiness Gate"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/BLUEPRINT.md" "v0.10.0 production cutover readiness gate"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "GH-891-RELEASE-V0100-FINAL-AUDIT-DOCS-RUNBOOK"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "Project Closure Count: 44 / 44 (100%)"
