...
require_file_contains "$NOTES" "#1286 是 historical construction closeout"
for file in "$README" "$GOAL" "$BLUEPRINT" "$ROADMAP" "$LATEST" "$AUDIT" "$NOTES" "$POLICY"; do
  require_file_contains "$file" "https://github.com/atxinbao/MTPRO/releases/tag/v0.21.0"
  require_file_contains "$file" "bca492ed48324a8057c5dc7223d740426a54c3b1"
  require_file_contains "$file" "2026-07-04T10:08:42Z"
done
...
require_file_contains "$VERIFICATION" "GH-1305 v0.21.0 Release Publication Fact Sync"
require_file_contains "$VERIFICATION" "https://github.com/atxinbao/MTPRO/releases/tag/v0.21.0"
require_file_contains "$VERIFICATION" "bca492ed48324a8057c5dc7223d740426a54c3b1"
require_file_contains "$VERIFICATION" "2026-07-04T10:08:42Z"
