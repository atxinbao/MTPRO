...
require_output_contains "$verify_output" "issue=GH-856"
require_output_contains "$verify_output" "validationAnchor=TVM-RELEASE-V090-FINAL-AUDIT-DOCS-RUNBOOK"
require_output_contains "$verify_output" "verificationAnchor=GH-856-VERIFY-V090-FINAL-AUDIT-DOCS-RUNBOOK"
require_output_contains "$verify_output" "checks=verify-v0.9.0-contract,verify-v0.9.0-dashboard-cli-operator-ux,verify-v0.9.0,automation-readiness,checks-run"
...
require_file_contains "Sources/MTPROCLI/main.swift" "mtpro verify v0.9.0"
