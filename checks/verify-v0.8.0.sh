...
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "MTPRO Release v0.8.0 Persistent Operator Runtime + Testnet Read-only Monitoring"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "bash checks/verify-v0.8.0.sh"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "MTPRO Release v0.8.0 Persistent Operator Runtime + Testnet Read-only Monitoring"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/BLUEPRINT.md" "v0.8.0 persistent operator runtime + testnet read-only monitoring"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "GH-820-RELEASE-V080-FINAL-AUDIT-DOCS-RUNBOOK"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "Project Closure Count: 42 / 42 (100%)"
require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "Release v0.8.0 Closure Snapshot"
require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "$AUDIT"
