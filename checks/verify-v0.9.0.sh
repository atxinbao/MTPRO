...
for publication_fact in \
  ...
  require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "$publication_fact"
done
...
require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "Release v0.9.0 Closure Snapshot"
