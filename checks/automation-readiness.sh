...
require_file "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md"
...
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "MTPRO Trading Validation and Parity Hardening"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Project goal"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Scope"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Non-goals"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Issue order"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Dependencies"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Validation requirements"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "Evidence requirements"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "First executable issue candidate"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "WIP=1"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "完整 issue execution contract 以 Linear 为准"
require_contains "docs/planning/mtpro-trading-validation-and-parity-hardening-plan.md" "本文档不授权执行"
...
require_contains "docs/planning/linear-draft-plan.md" "mtpro-trading-validation-and-parity-hardening-plan.md"
