...
require_file "docs/validation/mtp-30-stage-audit-input.md"
require_file "docs/validation/mtp-37-stage-audit-input.md"
...
require_contains "docs/validation/validation-plan.md" "docs/validation/mtp-30-stage-audit-input.md"
require_contains "docs/validation/validation-plan.md" "MTP-37 Validation Docs / Stage Audit Input Validation"
require_contains "docs/validation/validation-plan.md" "docs/validation/mtp-37-stage-audit-input.md"
...
require_contains "docs/validation/trading-validation-matrix.md" "docs/validation/mtp-37-stage-audit-input.md"
require_contains "docs/validation/trading-validation-matrix.md" "bash checks/run.sh"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Issue / PR evidence input"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Trading validation evidence chain"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Automation readiness evidence"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Known boundaries"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Root Docs Delta input"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "Stage Code Audit handoff checklist"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "docs/audit/mtpro-trading-validation-and-parity-hardening-stage-code-audit.md"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "MTP-24"
require_contains "docs/validation/mtp-30-stage-audit-input.md" "MTP-30"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Issue / PR evidence input"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Paper runtime validation evidence chain"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Automation readiness evidence"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Known boundaries"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Root Docs Delta input"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "Stage Code Audit handoff checklist"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "docs/audit/mtpro-paper-session-runtime-v1-stage-code-audit.md"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "MTP-31"
require_contains "docs/validation/mtp-37-stage-audit-input.md" "MTP-37"
...
require_contains "docs/validation/latest-verification-summary.md" "docs/validation/mtp-37-stage-audit-input.md"
