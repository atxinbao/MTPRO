...
VALIDATE_B_OUTPUT="$(run_readiness_cli validate "$ASSESSMENT_B")"
assert_common_cli_boundary "validate" "$VALIDATE_B_OUTPUT"
require_cli_output_contains "validate" "$VALIDATE_B_OUTPUT" "validationState=valid"
EXPORT_B_OUTPUT="$(run_readiness_cli export "$ASSESSMENT_B")"
assert_common_cli_boundary "export" "$EXPORT_B_OUTPUT"
require_cli_output_contains "export" "$EXPORT_B_OUTPUT" "exportSnapshotOnly=true"
