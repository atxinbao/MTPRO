...
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "#1110 beta safety guards closed / done"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "#1110 beta safety guards closed / done"
