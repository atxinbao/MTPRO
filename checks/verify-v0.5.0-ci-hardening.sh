...
require_file_contains ".github/workflows/checks.yml" "\"release/**\""
require_file_contains ".github/workflows/checks.yml" "tags:"
require_file_contains ".github/workflows/checks.yml" "\"v*\""
require_file_contains ".github/workflows/checks.yml" "pr_fast_checks:"
require_file_contains ".github/workflows/checks.yml" "name: pr-fast-checks"
require_file_contains ".github/workflows/checks.yml" "bash checks/automation-readiness.sh"
require_file_contains ".github/workflows/checks.yml" "bash checks/verify-ci-pr-fast-lane-release-matrix.sh"
...
require_file_contains ".github/workflows/checks.yml" "needs.pr_fast_checks.result"
require_file_contains "checks/run.sh" "bash checks/verify-v0.5.0-ci-hardening.sh"
require_file_contains "checks/run.sh" "bash checks/verify-ci-pr-fast-lane-release-matrix.sh"
require_file_contains "checks/automation-readiness.sh" "GH-738-VERIFY-V050-CI-HARDENING"
require_file_contains "checks/automation-readiness.sh" "CI-PR-FAST-LANE-RELEASE-MATRIX"
...
require_file_contains "docs/automation/ci-reproducibility.md" "CI-PR-FAST-LANE-RELEASE-MATRIX"
