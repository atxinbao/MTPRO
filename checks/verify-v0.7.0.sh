...
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "MTPRO Release v0.7.0 Operator Runtime Session + Real Testnet Read-only Connectivity"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "bash checks/verify-v0.7.0.sh"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "MTPRO Release v0.7.0 Operator Runtime Session + Real Testnet Read-only Connectivity"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/BLUEPRINT.md" "v0.7.0 operator runtime session + real testnet read-only connectivity"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "GH-792-RELEASE-V070-FINAL-AUDIT-DOCS-RUNBOOK"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/roadmap.md" "Project Closure Count: 41 / 41 (100%)"
require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "Release v0.7.0 Closure Snapshot"
require_file_contains "docs/history/validation-pre-canonicalization-2026-07-20/latest-verification-summary.md" "docs/audit/mtpro-release-v0.7.0-operator-runtime-session-testnet-read-only-connectivity-stage-code-audit.md"
