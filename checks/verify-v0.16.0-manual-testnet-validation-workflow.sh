...
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "#1111 manual testnet validation workflow closed / done"
require_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "#1111 manual testnet validation workflow closed / done"
reject_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/README.md" "#1111 manual testnet validation workflow is current WIP=1"
reject_file_contains "docs/history/root-docs-pre-canonicalization-2026-07-20/GOAL.md" "#1111 manual testnet validation workflow is current WIP=1"
